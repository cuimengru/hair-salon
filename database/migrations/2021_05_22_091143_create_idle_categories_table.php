...
class CreateIdleCategoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('idle_categories', function (Blueprint $table) {
            $table->id();
        ...
        DB::statement("ALTER TABLE idle_categories comment '闲置商品类目表'");
    }
    ...
    {
        Schema::dropIfExists('idle_categories');
    }
}
